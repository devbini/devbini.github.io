...
function move(type) {
    document.querySelector(".divpage").classList.add("move");

    sleep(1000).then(() => document.getElementById("MainPage").classList.remove("ZUP"))
    .then(() => document.getElementById("About").classList.remove("ZUP"))
